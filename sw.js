...
// (*** هام: تم تغيير الرقم إلى v50 لإجبار المتصفح على نسيان الكاش القديم تماماً ***)
const CACHE_NAME = 'tawal-academy-cache-v50'; 
const DATA_CACHE_NAME = 'tawal-data-cache-v25';
const FONT_CACHE = 'tawal-fonts-cache-v5';

// تأكد أن هذا المسار يطابق اسم المستودع الخاص بك على GitHub
// إذا كان اسم المستودع مختلفاً، قم بتغيير هذه القيمة
const BASE_PATH = '/tawal-platform/'; 

// قائمة الملفات التي سيتم تخزينها (تم تحديث أرقام الإصدارات لـ 19.0.0)
const CORE_FILES_TO_CACHE = [
    ...
    `${BASE_PATH}style.css?v=19.0.0`,          // تحديث الستايل
    `${BASE_PATH}app.js?v=19.0.0`,             // ✅ النسخة الجديدة التي تعالج مشكلة الطالب المحذوف
    `${BASE_PATH}control_panel.js?v=19.0.0`    // ✅ النسخة الجديدة التي تخفي القسم الزائد
];
